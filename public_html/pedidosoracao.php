	...
	<div id="body">
		...
		<?php require('navvert.php')?>
			...
			<div id="content">
				...
				<p>Você pode fazer aqui seus pedidos de Oração, bem como interceder pelos vários pedidos aqui publicado.</p>
				<form action="controls/addpedido.php" method="post">
				...
				<p><label for="post">Seu Pedido:</label><textarea cols="30" rows="3" name="post" id="post"></textarea></p>
